...
def run_test_problem1a():
    ...
    # Test 3:
    expected = -1.129  # This is APPROXIMATELY the correct answer.
    answer = problem1a(7, -17)
    print()
    print('Test 3 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 4:
    expected = 1.647  # This is APPROXIMATELY the correct answer.
    answer = problem1a(0, 4)
    print()
...
def run_test_problem1b():
    ...
    # Test 4:
    expected = 180  # This is APPROXIMATELY the correct answer.
    answer = problem1b(29, 39)
    print()
    print('Test 4 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
